class TypeformOnboarding {
    ...
    async testWebhook() {
        ...
        try {
            ...
            // Create test payload similar to real submission
            const testPayload = {
                timestamp: new Date().toISOString(),
                title: this.config.title,
            ...
            if (response.ok) {
                testButton.textContent = '✅ Webhook Success!';
                testButton.style.background = 'rgba(0, 212, 170, 0.3)';
                console.log('Webhook test successful!');
                
                // Show success toast
                this.showGentleError('Webhook test successful! Check your n8n workflow.');
            } else {
                throw new Error(`Webhook failed with status: ${response.status}`);
            }
        } catch (error) {
            console.error('Webhook test error:', error);
            testButton.textContent = '❌ Webhook Failed';
            testButton.style.background = 'rgba(255, 107, 107, 0.3)';
            
            // Show error with more details
            this.showError(`Webhook test failed: ${error.message}`);
        } finally {
    ...
    generateTestMarkdown() {
        return `# Brand Discovery & Onboarding (TEST DATA)
...
**Test Brand Co.** was founded in 2020 when our founders realized there was a gap in the market for authentic, sustainable products. We started in a small garage with just an idea and a lot of determination.

## What's your mission?

**To create products that make a positive impact on both people and the planet.**

## What's your vision?

**In 5-10 years, we envision being the leading sustainable brand in our category, known for innovation and authenticity.**

## What are your core values?

1. **Sustainability** - Environmental responsibility in everything we do
2. **Authenticity** - Being genuine in all our communications
3. **Innovation** - Constantly improving and evolving
4. **Community** - Building meaningful relationships with customers
...
Our ideal customers are environmentally conscious millennials and Gen Z consumers who value quality over quantity. They care deeply about the impact of their purchases and are willing to pay more for products that align with their values.

## Competitors & Industry

Our main competitors include EcoFriendly Corp, Green Solutions Ltd, and Sustainable Products Inc. What makes us different is our commitment to complete transparency in our supply chain and our innovative approach to sustainable packaging.

---

*Generated by Brand Discovery & Onboarding (TEST) on ${new Date().toLocaleDateString()}*`;
    }

    generateTestResponses() {
        return {
            brandStory: "Test Brand Co. was founded in 2020 when our founders realized there was a gap in the market for authentic, sustainable products.",
            mission: "To create products that make a positive impact on both people and the planet.",
            vision: "In 5-10 years, we envision being the leading sustainable brand in our category.",
            purpose: "We exist to prove that business can be a force for good.",
            coreValues: "1. Sustainability\n2. Authenticity\n3. Innovation\n4. Community",
            personality: ["Friendly", "Innovative", "Trusted", "Approachable"],
            targetAudience: "Environmentally conscious millennials and Gen Z consumers who value quality over quantity.",
            competitors: "Our main competitors include EcoFriendly Corp, Green Solutions Ltd, and Sustainable Products Inc.",
            runsPaidAds: "Yes",
            adSpend: "$10,000–$50,000"
        };
    }
}
